...
class Chip(models.Model):
    ...
    chip_line_number = models.CharField(max_length=50, default='', blank=True)
    chip_plan = models.CharField(max_length=50, default='', blank=True)
    chip_company = models.CharField(max_length=50, default='', blank=True)
    chip_apn = models.CharField(max_length=50, default='', blank=True)
    ...
    linked_at = models.CharField(max_length=50,default='',blank=True)
    linked_by = models.CharField(max_length=50, default='', blank=True)
    ...
    cr_gps = models.CharField(max_length=50, default='', blank=True)
    cod_cliente = models.CharField(max_length=50, default='', blank=True)
    amount_nf = models.DecimalField(max_digits=50, default=0, blank=True, decimal_places=2)
    amount_charged = models.DecimalField(max_digits=50, default=0, blank=True, decimal_places=2)